...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Thu Mar 7 20:57:02 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qt_rpn_ga1.0.0/ && $(COPY_FILE) --parents wheel.h util.h rpn_gene.h rpn_dna.h rpn.h .tmp/qt_rpn_ga1.0.0/ && $(COPY_FILE) --parents main.cpp wheel.cpp util.cpp rpn_gene.cpp rpn_dna.cpp rpn.cpp .tmp/qt_rpn_ga1.0.0/ && (cd `dirname .tmp/qt_rpn_ga1.0.0` && $(TAR) qt_rpn_ga1.0.0.tar qt_rpn_ga1.0.0 && $(COMPRESS) qt_rpn_ga1.0.0.tar) && $(MOVE) `dirname .tmp/qt_rpn_ga1.0.0`/qt_rpn_ga1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qt_rpn_ga1.0.0
