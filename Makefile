...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Sun Mar 10 14:35:53 2013
# Project:  qt_rpn_ga.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile qt_rpn_ga.pro
#############################################################################
...
Makefile: qt_rpn_ga.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile qt_rpn_ga.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qt_rpn_ga1.0.0/ && $(COPY_FILE) --parents wheel.h util.h rpn_gene.h rpn_dna.h rpn.h rpn_pool.h rpn_dna_comparator.h loud.h .tmp/qt_rpn_ga1.0.0/ && $(COPY_FILE) --parents main.cpp wheel.cpp util.cpp rpn_gene.cpp rpn_dna.cpp rpn.cpp rpn_pool.cpp rpn_dna_comparator.cpp loud.cpp .tmp/qt_rpn_ga1.0.0/ && (cd `dirname .tmp/qt_rpn_ga1.0.0` && $(TAR) qt_rpn_ga1.0.0.tar qt_rpn_ga1.0.0 && $(COMPRESS) qt_rpn_ga1.0.0.tar) && $(MOVE) `dirname .tmp/qt_rpn_ga1.0.0`/qt_rpn_ga1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qt_rpn_ga1.0.0
...
loud.o: loud.cpp loud.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o loud.o loud.cpp
